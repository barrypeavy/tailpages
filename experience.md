  ...
  <div class="flex flex-wrap text-sm">
    <div class="w-full">
      ...
      <div class="grid grid-cols-12 gap-x-4 gap-y-2 md:gap-y-12">
        ...
        <div class="col-start-1 col-end-12 md:col-start-1 md:col-end-4 md:border-e">
          <p class="mb-0.5"><a class="text-base font-semibold text-amber-600 hover:text-amber-700 underline decoration-amber-200 underline-offset-2 leading-tight" href="https://www.imdb.com/name/nm11919197/" target="_blank">Self-Employed Actor</a><i class="fa-solid fa-up-right-from-square fa-sm text-gray-400 ms-1"></i></p>
          <p class="text-gray-400 text-sm font-medium">OCT 2018 &ndash; Present</p>
          <p class="text-gray-400 text-xs">Various Locations</p>
        </div> <!-- left -->
        <div class="col-start-1 col-end-12 md:col-start-4 md:col-end-12">
          <h2 class="text-base md:text-lg font-semibold">Commercial / Background Actor</h2>
          <p>Occasionally perform as a commercial actor and background actor. Featured in international commercials for <a class="text-amber-500 hover:text-amber-600 underline decoration-amber-200 underline-offset-2" href="https://youtu.be/GA8F8o5bkbA?si=yO0DZQtUnOWm39gX" target="_blank">Johnnie Walker</a>. Appeared in numerous shows, movies, and videos — including Ozark, Stranger Things, Snapped: Notorious, Storm of Suspicion, Deadly Cults, Your Worst Nightmare, American Soul, and others.</p>  
        </div> <!-- right -->
        <div class="col-start-1 col-end-12 md:col-start-1 md:col-end-4 md:border-e mt-5 md:mt-0">
          ...
          <p class="text-gray-400 text-sm font-medium">JAN 2013 &ndash; DEC 2023</p>
          <p class="text-gray-400 text-xs">Remote</p>
        </div> <!-- left -->
        <div class="col-start-1 col-end-12 md:col-start-4 md:col-end-12">
        ...
        <div class="col-start-1 col-end-12 md:col-start-1 md:col-end-4 md:border-e mt-5 md:mt-0">
          <p class="mb-0.5"><a class="text-base font-semibold text-amber-600 hover:text-amber-700 underline decoration-amber-200 underline-offset-2 leading-tight" href="https://en.wikipedia.org/wiki/NIC_Inc." target="_blank">National Information Consortium (NIC)</a> - <a class="text-base font-semibold text-amber-600 hover:text-amber-700 underline decoration-amber-200 underline-offset-2 leading-tight" href="https://gta.georgia.gov/" target="_blank">Georgia Technology Authority</a><i class="fa-solid fa-up-right-from-square fa-sm text-gray-400 ms-1"></i></p>
        ...
        <div class="col-start-1 col-end-12 md:col-start-4 md:col-end-12">
          ...
          <p class="mb-2">NIC was a private company contracted by the State of Georgia. We worked within the Georgia Technology Authority (know as GeorgiaNet at the time).</p>
