    ...
    <div class="w-full">
      ...
      <div class="grid grid-cols-12 gap-x-4 gap-y-8">
        ...
        <div class="col-start-1 col-end-4 border-e">
          ...
          <p class="text-gray-400 text-sm">JAN 2007 &ndash; Present</p>
          <p class="text-gray-400 text-xs">Remote; Atlanta, GA</p>
        </div> <!-- left -->
        <div class="col-start-4 col-end-12">
          <h2 class="text-lg font-semibold">Web Designer | Front-End Developer</h2>
          <p>CSS / HTML / Bootstrap / Wordpress Designer / Developer / Graphic Designer for various clients.</p>  
        </div> <!-- right -->
        <div class="col-start-1 col-end-4 border-e">
