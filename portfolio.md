    ...
    <div class="w-full">
      ...
      <div class="grid grid-cols-12 gap-x-4 gap-y-2 md:gap-y-12">
        ...
        <div class="col-start-1 col-end-12 md:col-start-4 md:col-end-12">
          <h2 class="uppercase text-center font-semibold text-gray-500 text-lg mb-5">Front-End Development</h2>
          ...
          <h2 class="uppercase text-center font-semibold text-gray-500 text-lg mb-5">Web UI Design</h2>
          ...
          <p class="text-xs text-right mb-0.5"><a class="font-semibold text-amber-500 hover:text-amber-600" href="#top">TOP<i class="fa-solid fa-arrow-turn-up fa-sm ms-1"></i></a></p>
          <h2 class="uppercase text-center font-semibold text-gray-500 text-lg mb-5">Figma Hi-Fi UI Mockups</h2>
